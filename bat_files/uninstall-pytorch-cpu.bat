...
@echo on
if exist .\winpython-pytorch-cpu\ rmdir .\winpython-pytorch-cpu\ /q /s
if exist run-pytorch-cpu.bat del /q run-pytorch-cpu.bat
...
(goto) 2>nul & if exist uninstall-pytorch-cpu.bat del /q uninstall-pytorch-cpu.bat
